...
```bash
git remote add encore encore://hostel-property-management-system-by4i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/hostel-property-management-system-by4i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/hostel-property-management-system-by4i/settings/integrations/github)
